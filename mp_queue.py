...
class Worker(Process):
    ...
    def __init__(self, queue, nb_ok, lock):
        self._queue = queue
        self._lock = lock
        self._nb_ok = nb_ok
    ...
    def run(self):
        ...
        while True:
            ...
            print("{}: Treating {} trials".format(self.pid, nb_trials))
            ...
            #   - End current loop
            if nb_trials == "STOP":
                print("Exiting and propagate poison pill")
                self._queue.put("STOP")
                break
